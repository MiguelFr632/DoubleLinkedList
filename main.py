class Passageiro:
    def __init__(self, nome, sobrenome, rg, cpf, endereco, tel_celular,
                 tel_fixo, status_voo, assento):
        self.nome = nome
...
class DoubleLinkedListIterator:
    ...
    def nextNode(
        self
    ):  # avança o iterador uma posição. para tal o iterador deve estar definido(sobre um Noh)
        if (self.iterator):
